...
const style = {
    wrapper: 'relative',
    container: 'before:content-[""] before:bg-black before:fixed before:top-0 before:left-0 before:right-0 before:bottom-0 before:bg-[url("https://media4.giphy.com/media/Jq1fsUYaiukkKecSBC/giphy.gif?cid=ecf05e476uamaojzkgzepfa0qivfn1gtmgzo6aurpa3fp94q&rid=giphy.gif&ct=g")] before:bg-auto before:bg-center before:opacity-90',
    contentWrapper: 'flex h-screen relative justify-center flex-wrap items-center',
    copyContainer: 'w-fit bg-black bg-opacity-10 rounded-md backdrop-blur px-2',
    title: 'relative text-white md:text-5xl sm:text-4xl font-semibold',
